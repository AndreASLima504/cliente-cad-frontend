...
})({"4GlBl":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e900d390caea5752";
"use strict";
...
},{}],"eopEi":[function(require,module,exports,__globalThis) {
...
$('#tabelaLista').on('click', '.excluir', async function() {
    ...
    var rowData = row.data();
    try {
        await (0, _axiosDefault.default).delete(url + `/${rowData['id']}`).then(function(response) {
            alert(response.data);
        });
        reloadTable();
    } catch (error) {
...
},{"axios":"kooH4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","regenerator-runtime/runtime":"f6ot0"}]},["4GlBl","eopEi"], "eopEi", "parcelRequire94c2")

//# sourceMappingURL=clientes.caea5752.js.map
